...
// export default function BoysGift() {
...
//                 <img src={Airplane} alt="Bag1" className="mx-auto w-[161px] h-[124px]" onClick={() => setSelectedBag(0)} />
//                 <img src={Car} alt="Bag1" className="mx-auto w-[161px] h-[124px]" onClick={() => setSelectedBag(0)} />
//             </div>
