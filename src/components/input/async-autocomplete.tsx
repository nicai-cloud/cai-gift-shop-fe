...
// export type AsyncAutocompleteOption<T> = {
//     id: React.Key;
//     value: T;
//     label: React.ReactNode;
// };

// export type AsyncAutocompleteProps<T, TFieldValues extends FieldValues, TName extends FieldPath<TFieldValues>> = {
//     label: string;
//     className?: React.HTMLAttributes<'input'>['className'];
//     // fetchOptions: (query: string) => Promise<AsyncAutocompleteOption<T>[]>;
//     fetchOptions: (query: string) => Promise<AsyncAutocompleteOption<string>[]>;
// } & UseControllerProps<TFieldValues, TName> & Omit<ComboboxInputProps, 'className' | 'label'>;

// export default function AsyncAutocomplete<T, TFieldValues extends FieldValues, TName extends FieldPath<TFieldValues>>(props: AsyncAutocompleteProps<T, TFieldValues, TName>) {
...
//     const selectValueCallback = useCallback(
//         (v: string | null) => {
//             field.onChange(v);
//         },
//         [field],
...
//         <Field className={cn}>
//             {/*
//         // @ts-expect-error: The typing here is very permissive for our needs. */}
//             <Combobox value={field.value} by="id" onChange={selectValueCallback}>
//                 <ComboboxInput
